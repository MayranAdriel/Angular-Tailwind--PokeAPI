...
(function (v) {
  ...
  d("Zone");
  let n = v.__Zone_symbol_prefix || "__zone_symbol__";
  function a(ee) {
    return n + ee;
  }
  let c = v[a("forceDuplicateZoneCheck")] === !0;
  if (v.Zone) {
    ...
    _transitionTo(i, g, k) {
      if (this._state === g || this._state === k)
        ...
        throw new Error(
          `${this.type} '${
            this.source
          }': can not transition to '${i}', expecting state '${g}'${
            k ? " or '" + k + "'" : ""
          }, was '${this._state}'.`
        );
    }
  ...
  let S = { name: "NO ZONE" },
    ...
    r = {
      ...
      scheduleMicroTask: w,
      showUncaughtError: () => !l[a("ignoreConsoleErrorUncaughtError")],
      patchEventTarget: () => [],
      patchOnProperties: z,
      patchMethod: () => z,
      bindArguments: () => [],
...
function na(v, N, d, u, n) {
  return Zone.current.scheduleMacroTask(v, N, d, u, n);
}
...
var aa = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope,
  ...
  $n = function (v) {
    ...
    let d = this || v.target || at,
      u = d[N],
      n;
    if (Fi && d === Xr && v.type === "error") {
      let a = v;
      (n =
        u && u.call(this, a.message, a.filename, a.lineno, a.colno, a.error)),
        n === !0 && v.preventDefault();
    } else
      (n = u && u.apply(this, arguments)),
        n != null && !n && v.preventDefault();
    return n;
  };
function Jn(v, N, d) {
  let u = bn(v, N);
  if (
    (!u && d && bn(d, N) && (u = { enumerable: !0, configurable: !0 }),
    !u || !u.configurable)
  )
    return;
  let n = je("on" + N + "patched");
  if (v.hasOwnProperty(n) && v[n]) return;
...
function Ui(v, N, d) {
  if (N) for (let u = 0; u < N.length; u++) Jn(v, "on" + N[u], d);
    ...
    let u = [];
    for (let n in v) n.slice(0, 2) == "on" && u.push(n);
    for (let n = 0; n < u.length; n++) Jn(v, u[n], d);
  }
}
je("originalInstance");
function ji(v, N) {
  ...
  Object.getOwnPropertySymbols(v).forEach((u) => {
    ...
    Object.defineProperty(N, u, {
      ...
      set: function (a) {
        (n && (!n.writable || typeof n.set != "function")) || (v[u] = a);
      },
      enumerable: n ? n.enumerable : !0,
      configurable: n ? n.configurable : !0,
    });
  });
}
var sa = !1;
  ...
  u = tr(
    ...
    (a) =>
      function (c, l) {
        let h = d(c, l);
        return h.cbIdx >= 0 && typeof l[h.cbIdx] == "function"
          ? Zone.current.scheduleMicroTask(h.name, l[h.cbIdx], h, n)
          : a.apply(c, l);
      }
  );
}
...
Zone.__load_patch("toString", (v) => {
  ...
  (a[d] = N), (Function.prototype.toString = a);
...
function Ki(v, N, d, u) {
  ...
  function re(w, _) {
    ...
    let Y = w;
    for (; Y && !Y.hasOwnProperty(n); ) Y = ea(Y);
    if ((!Y && w[n] && (Y = w), !Y || Y[h])) return !1;
          ...
          if (le) {
            ...
            if (me) {
              ...
              for (let Ae = 0; Ae < _e.length; Ae++) {
                ...
                this[a].call(this, K, Ke, Me.options);
              }
            }
            if (ge) {
              let _e = ge.slice();
...
function la(v, N) {
  ...
  let u = v[d[Rt]],
    n = v[d[It]];
  return u ? (n ? u.concat(n) : u.slice()) : n ? n.slice() : [];
}
...
Zone.__load_patch("fs", () => {
  ...
  v &&
    [
      ...
      .filter((d) => !!v[d] && typeof v[d] == "function")
      .forEach((d) => {
        En(v, d, (u, n) => ({
          name: "fs." + d,
          args: n,
          cbIdx: n.length > 0 ? n.length - 1 : -1,
          target: u,
        }));
      });
});
function Xi(v, N) {
  N.patchMethod(
    ...
    (d) =>
      function (u, n) {
        Zone.current.scheduleMicroTask("queueMicrotask", n[0]);
      }
  );
}
var Zr = je("zoneTask");
function Qt(v, N, d, u) {
  ...
  function l(s) {
    ...
    return (
      ...
      (E.handleId = n.apply(v, E.args)),
      s
    );
  }
  function h(s) {
    return a.call(v, s.data.handleId);
  }
  (n = tr(
    v,
    N,
  ...
  try {
    ...
    if (!(v.setTimeout === u.setTimeout) && !Qn) {
      ...
      u.setTimeout = function () {
        return (d = !0), a.apply(this, arguments);
      };
      let c = v.setTimeout(() => {}, 100);
      clearTimeout(c), (u.setTimeout = a);
    }
    Qt(u, $t, Jt, "Timeout"),
      Qt(u, $t, Jt, "Interval"),
      Qt(u, $t, Jt, "Immediate");
...
Zone.__load_patch("handleUnhandledPromiseRejection", (v, N, d) => {
  ...
  function u(n) {
    return function (a) {
      la(process, n).forEach((l) => {
        n === "unhandledRejection"
          ? l.invoke(a.rejection, a.promise)
          : n === "rejectionHandled" && l.invoke(a.promise);
      });
    };
  }
});
  ...
  v &&
    ["randomBytes", "pbkdf2"].forEach((d) => {
      En(v, d, (u, n) => ({
        ...
        args: n,
        cbIdx:
          n.length > 0 && typeof n[n.length - 1] == "function"
            ? n.length - 1
            : -1,
        target: v,
      }));
...
Zone.__load_patch("console", (v, N) => {
  [
    ...
    let n = (console[N.__symbol__(u)] = console[u]);
    n &&
      (console[u] = function () {
        let a = Oi.call(arguments);
        return N.current === N.root ? n.apply(this, a) : N.root.run(n, this, a);
      });
  });
});
  ...
  fa = ue({
    "external/npm/node_modules/domino/lib/UIEvent.js"(v, N) {
      ...
      u.prototype = Object.create(d.prototype, {
        constructor: { value: u },
        initUIEvent: {
          value: function (n, a, c, l, h) {
            this.initEvent(n, a, c), (this.view = l), (this.detail = h);
          },
        },
      });
    },
  ...
  ha = ue({
    "external/npm/node_modules/domino/lib/MouseEvent.js"(v, N) {
      ...
      u.prototype = Object.create(d.prototype, {
        constructor: { value: u },
        initMouseEvent: {
          value: function (n, a, c, l, h, s, E, b, y, x, R, I, re, B, w) {
            switch (
              (this.initEvent(n, a, c, l, h),
              (this.screenX = s),
              (this.screenY = E),
              (this.clientX = b),
              (this.clientY = y),
...
` +
        ...
        (v.expose = function (n, a) {
          for (var c in n)
            Object.defineProperty(a.prototype, c, { value: n[c], writable: u });
        }),
        (v.merge = function (n, a) {
          for (var c in a) n[c] = a[c];
        }),
        (v.documentOrder = function (n, a) {
          return 3 - (n.compareDocumentPosition(a) & 6);
        }),
        (v.toASCIILowerCase = function (n) {
          return n.replace(/[A-Z]+/g, function (a) {
            return a.toLowerCase();
          });
        }),
        (v.toASCIIUpperCase = function (n) {
          return n.replace(/[a-z]+/g, function (a) {
    ...
    "external/npm/node_modules/domino/lib/EventTarget.js"(v, N) {
      ...
      a.prototype = {
        ...
        _dispatchEvent: function (l, h) {
          ...
          (!l._initialized || l._dispatching) && n.InvalidStateError(),
            (l.isTrusted = h),
            (l._dispatching = !0),
            (l.target = this);
    ...
    "external/npm/node_modules/domino/lib/LinkedList.js"(v, N) {
      ...
      var d = Be(),
        u = (N.exports = {
          valid: function (n) {
            return (
              d.assert(n, "list falsy"),
              d.assert(n._previousSibling, "previous falsy"),
              d.assert(n._nextSibling, "next falsy"),
              !0
            );
          },
          insertBefore: function (n, a) {
            d.assert(u.valid(n) && u.valid(a));
            var c = n,
              l = n._previousSibling,
              h = a,
          ...
          replace: function (n, a) {
            d.assert(u.valid(n) && (a === null || u.valid(a))),
              a !== null && u.insertBefore(a, n),
              u.remove(n),
              d.assert(u.valid(n) && (a === null || u.valid(a)));
          },
          remove: function (n) {
            d.assert(u.valid(n));
            var a = n._previousSibling;
            if (a !== n) {
              var c = n._nextSibling;
              (a._nextSibling = c),
...
`),
          ...
          case 4:
            ...
            w.nodeType === 1 && w.namespaceURI === u.HTML
              ? (P = w.tagName)
              : (P = ""),
              n[P] || (P === "NOSCRIPT" && w.ownerDocument._scripting_enabled)
                ? (_ += B.data)
                : (_ += s(B.data));
            break;
          case 8:
      ...
      c.prototype = Object.create(d.prototype, {
        ...
        _ensureInsertValid: {
          value: function (L, P, $) {
            ...
            switch (
              (L.isAncestor(f) && a.HierarchyRequestError(),
              (P !== null || !$) && P.parentNode !== f && a.NotFoundError(),
              L.nodeType)
            ) {
              case B:
              case re:
            ...
            if (f.nodeType === I)
              switch (L.nodeType) {
                ...
                case B:
                  switch (
                    (L._countChildrenOfType(s) > 0 && a.HierarchyRequestError(),
                    ...
                    case 1:
                      if (P !== null)
                        for (
                          $ && P.nodeType === re && a.HierarchyRequestError(),
                            r = P.nextSibling;
                          r !== null;
                          r = r.nextSibling
                        )
                          r.nodeType === re && a.HierarchyRequestError();
                ...
                case re:
                  if (P === null)
                    f._countChildrenOfType(l) && a.HierarchyRequestError();
                  else
                    for (
                      r = f.firstChild;
                      r !== null && r !== P;
                      ...
                      r.nodeType === l && a.HierarchyRequestError();
            ...
            else L.nodeType === re && a.HierarchyRequestError();
          },
        },
        insertBefore: {
          value: function (L, P) {
        ...
        removeChild: {
          value: function (L) {
            var P = this;
            if (!L.nodeType) throw new TypeError("not a node");
            return L.parentNode !== P && a.NotFoundError(), L.remove(), L;
          },
        },
        replaceChild: {
          value: function (L, P) {
        ...
        ensureSameDoc: {
          value: function (F) {
            F.ownerDocument === null
              ...
              : F.ownerDocument !== this.doc && a.WrongDocumentError();
          },
        },
        ...
        _insertOrReplace: {
          value: function (L, P, $) {
            var f = this,
              ...
              r;
            if (
              (f.nodeType === B && f.rooted && a.HierarchyRequestError(),
              L._childNodes &&
  ...
  Qi = ue({
    "external/npm/node_modules/domino/lib/NodeList.es6.js"(v, N) {
      ...
      N.exports = class extends Array {
        constructor(u) {
          if ((super((u && u.length) || 0), u)) for (var n in u) this[n] = u[n];
        }
        item(u) {
          return this[u] || null;
        }
    ...
    "external/npm/node_modules/domino/lib/attributes.js"(v) {
      ...
      function d(u) {
        ...
        var a = u.type === "unsigned long",
          ...
          E = u.setmin;
        return (
          h === void 0 && (a && (h = 0), c && (h = -2147483648), l && (h = 1)),
          s === void 0 && (a || c || l) && (s = 2147483647),
          {
            get: function () {
              ...
              if (
                ...
                return n.call(this);
              if (a || c || l) {
                if (!/^[ \t\n\f\r]*[-+]?[0-9]/.test(b)) return n.call(this);
                y = y | 0;
              }
              return y;
            },
            set: function (b) {
              u.float || (b = Math.floor(b)),
                ...
                a
                  ? (b = b < 0 || b > 2147483647 ? n.call(this) : b | 0)
                  : l
                  ? (b = b < 1 || b > 2147483647 ? n.call(this) : b | 0)
                  : c &&
                    (b =
                      b < -2147483648 || b > 2147483647 ? n.call(this) : b | 0),
                this._setattr(u.name, String(b));
            },
          }
        );
      }
      v.registerChangeHandler = function (u, n, a) {
        var c = u.prototype;
        Object.prototype.hasOwnProperty.call(c, "_attributeChangeHandlers") ||
          ...
          (c._attributeChangeHandlers[n] = a);
      };
    },
  }),
  Ji = ue({
        ...
        next: {
          value: function () {
            var n =
              ...
              a;
            for (
              n.nodeType === d.DOCUMENT_NODE
                ? (a = n.documentElement)
                : (a = n.nextElement(this.root));
              a;
  ...
  _a = ue({
    "external/npm/node_modules/domino/lib/DOMTokenList.js"(v, N) {
      ...
      Object.defineProperties(u.prototype, {
        ...
        replace: {
          value: function (s, E) {
            String(E) === "" && d.SyntaxError(), (s = a(s)), (E = a(E));
            var b = l(this),
              y = b.indexOf(s);
            if (y < 0) return !1;
            var x = b.indexOf(E);
            ...
            get: function () {
              if (this.parentNode) {
                for (var n = this.nextSibling; n !== null; n = n.nextSibling)
                  if (n.nodeType === d.ELEMENT_NODE) return n;
              }
              return null;
            },
          },
  ...
  Er = ue({
    "external/npm/node_modules/domino/lib/Element.js"(v, N) {
      ...
      (w.prototype = Object.create(x.prototype, {
          ...
          value: function (r, p) {
            ...
            (!(D instanceof w) ||
              (D.ownerDocument.isHTML &&
                D.localName === "html" &&
                D.namespaceURI === n.HTML)) &&
              (D = D.ownerDocument.createElementNS(n.HTML, "body"));
        ...
        setAttributeNS: {
          value: function (r, p, D) {
            ...
            ((z !== null && r === null) ||
              (z === "xml" && r !== n.XML) ||
              ((p === "xmlns" || z === "xmlns") && r !== n.XMLNS) ||
              (r === n.XMLNS && !(p === "xmlns" || z === "xmlns"))) &&
              u.NamespaceError(),
        ...
        a.registerChangeHandler(w, "id", function (o, r, p, D) {
          o.rooted &&
            (p && o.ownerDocument.delId(p, o),
            D && o.ownerDocument.addId(D, o));
        }),
        a.registerChangeHandler(w, "class", function (o, r, p, D) {
      ...
      function f(o) {
        return function (r) {
          return r.namespaceURI !== n.HTML ? !1 : r.getAttribute("name") === o;
        };
      }
    },
  }),
      ...
      function a(h, s) {
        ...
        return (
          ...
          E !== null
            ...
            : h === s
            ? null
            : ((E = h.nextSibling), E !== null ? E : n(h, s))
        );
      }
      function c(h) {
  ...
  es = ue({
    "external/npm/node_modules/domino/lib/TreeWalker.js"(v, N) {
      ...
      function E(b, y, x) {
        (!b || !b.nodeType) && a.NotSupportedError(),
          (this._root = b),
        ...
        nextNode: {
          value: function () {
            ...
            e: for (;;) {
              ...
              for (
                I = n.nextSkippingChildren(y, this.root);
                I;
                I = n.nextSkippingChildren(y, this.root)
              ) {
                if (
    ...
    "external/npm/node_modules/domino/lib/NodeIterator.js"(v, N) {
      ...
      function l(s, E) {
        ...
        for (b = s._referenceNode, y = s._pointerBeforeReferenceNode; ; ) {
          if (y === E) y = !y;
          else if (((b = a(b, s._root, E)), b === null)) return null;
      ...
      function h(s, E, b) {
        (!s || !s.nodeType) && n.NotSupportedError(),
          (this._root = s),
  ...
  kn = ue({
    "external/npm/node_modules/domino/lib/URL.js"(v, N) {
      ...
      function d(u) {
        ...
        this.url = u.replace(/^[ \t\n\r\f]+|[ \t\n\r\f]+$/g, "");
        var n = d.pattern.exec(this.url);
        if (n) {
          if ((n[2] && (this.scheme = n[2]), n[4])) {
            var a = n[4].match(d.userinfoPattern);
            if (
              (a &&
                ((this.username = a[1]),
                (this.password = a[3]),
                (n[4] = n[4].substring(a[0].length))),
              n[4].match(d.portPattern))
            ) {
              var c = n[4].lastIndexOf(":");
              (this.host = n[4].substring(0, c)),
                (this.port = n[4].substring(c + 1));
            } else this.host = n[4];
          }
          n[5] && (this.path = n[5]),
            n[6] && (this.query = n[7]),
      ...
      (d.pattern =
        ...
        (d.prototype = {
          ...
          resolve: function (u) {
            ...
            function l(s, E) {
              if (n.host !== void 0 && !n.path) return "/" + E;
              var b = s.lastIndexOf("/");
        ...
        for (; a < u.length; )
          switch (u.charCodeAt(a++)) {
            ...
            case 39:
              l === 0
                ? (l = 39)
                : l === 39 && u.charCodeAt(a - 1) !== 92 && (l = 0);
              break;
            case 34:
              l === 0
                ? (l = 34)
                : l === 34 && u.charCodeAt(a - 1) !== 92 && (l = 0);
              break;
            case 58:
              !E &&
                c === 0 &&
                l === 0 &&
                ((E = d(u.substring(s, a - 1).trim())), (h = a));
              break;
            case 59:
              if (E && h > 0 && c === 0 && l === 0) {
                let y = u.substring(h, a - 1).trim();
                n.push(E, y), (s = a), (h = 0), (E = null);
              }
              break;
          }
        if (E && h) {
      ...
      function c(h) {
        ...
        for (let b = 0; b < E.length; b += 2) {
          let y = E[b],
            x = E[b + 1];
          x.endsWith(a) &&
            ((s.priority[y] = "important"), (x = x.slice(0, -a.length).trim())),
            (s.property[y] = x);
        }
        return s;
      }
      ...
      (u.prototype = Object.create(Object.prototype, {
        ...
        protocol: {
          ...
          set: function (n) {
            ...
            c.isAbsolute() &&
              ((n = n.replace(/:+$/, "")),
              (n = n.replace(/[^-+\.a-zA-Z0-9]/g, d.percentEncode)),
              n.length > 0 && ((c.scheme = n), (a = c.toString()))),
              (this.href = a);
          },
        },
        host: {
          ...
          set: function (n) {
            ...
            c.isAbsolute() &&
              ...
              n.length > 0 &&
                ((c.host = n), delete c.port, (a = c.toString()))),
              (this.href = a);
          },
        },
        hostname: {
          ...
          set: function (n) {
            ...
            c.isAbsolute() &&
              ...
              n.length > 0 && ((c.host = n), (a = c.toString()))),
              (this.href = a);
          },
        },
        port: {
          ...
          set: function (n) {
            ...
            c.isAbsolute() &&
              ...
              (n = n.replace(/^0+/, "")),
              n.length === 0 && (n = "0"),
              parseInt(n, 10) <= 65535 && ((c.port = n), (a = c.toString()))),
              (this.href = a);
          },
        },
        pathname: {
        ...
        origin: {
          get: function () {
            ...
            if (n == null) return "";
            var a = function (c) {
              var l = [n.scheme, n.host, +n.port || c];
        ...
        (u._inherit = function (n) {
          Object.getOwnPropertyNames(u.prototype).forEach(function (a) {
            if (!(a === "constructor" || a === "href")) {
              var c = Object.getOwnPropertyDescriptor(u.prototype, a);
      ...
      function c(l, h) {
        ...
        h.forEach(function (E) {
          Object.defineProperty(s, "on" + E, {
            ...
            d.registerChangeHandler(l, "on" + E, a);
        });
      }
    },
  }),
    ...
    "external/npm/node_modules/domino/lib/htmlelts.js"(v) {
      ...
      var y = {
        ...
        I = (v.HTMLElement = s({
          ...
          name: "HTMLElement",
          ctor: function (_, S, m) {
            d.call(this, _, S, n.NAMESPACE.HTML, m);
          },
          props: {
...
`
  ...
  Mn = ue({
    "external/npm/node_modules/domino/lib/HTMLParser.js"(v, N) {
      ...
      m[a.HTML] = { __proto__: null, address: !0, div: !0, p: !0 };
      var ie = Object.create(null);
      ie[a.HTML] = { __proto__: null, dd: !0, dt: !0 };
      ...
      L[a.HTML] = { __proto__: null, table: !0, template: !0, html: !0 };
      ...
      $[a.HTML] = { __proto__: null, tr: !0, template: !0, html: !0 };
      var f = Object.create(null);
      f[a.HTML] = {
        __proto__: null,
        button: !0,
      ...
      (r[a.HTML] = Object.create(o[a.HTML])),
        (r[a.HTML].ol = !0),
        (r[a.HTML].ul = !0);
      ...
      var O = Object.create(null);
      O[a.HTML] = { __proto__: null, optgroup: !0, option: !0 };
      ...
      ne[a.SVG] = { __proto__: null, foreignObject: !0, desc: !0, title: !0 };
      var ee = {
          __proto__: null,
      ...
      (be.ElementStack = function () {
        ...
        (be.ElementStack.prototype.inSelectScope = function (U) {
          for (var V = this.elements.length - 1; V >= 0; V--) {
            var ce = this.elements[V];
            if (ce.namespaceURI !== a.HTML) return !1;
            var te = ce.localName;
            if (te === U) return !0;
      ...
      function be(U, V, ce) {
        ...
        if (((Se._parser = kr), (Se._scripting_enabled = Nr), V)) {
          ...
          Se._appendChild(xn),
            C.push(xn),
            V instanceof l.HTMLTemplateElement && dt.push(gn),
            hr();
        ...
        function xa() {
          ...
          switch (T[0]) {
            case '"':
            case "'":
              (T = T.substring(1, M - 1)), (ae += e[0].length - 1), (A = un);
              break;
            default:
...
` && (e = e.substring(1)),
        ...
        function Dr(e) {
          ...
          if (
            ...
            t instanceof l.HTMLTemplateElement && (t = t.content),
            (Q = e(t.ownerDocument)),
            Q.nodeType === n.TEXT_NODE)
          ) {
            var he;
            if (
              (T ? (he = T.previousSibling) : (he = t.lastChild),
              he && he.nodeType === n.TEXT_NODE)
            )
        ...
        function hr() {
          for (var e = !1, t = C.elements.length - 1; t >= 0; t--) {
            var T = C.elements[t];
            if (
              (t === 0 && ((e = !0), Ft && (T = V)), T.namespaceURI === a.HTML)
            ) {
              var M = T.localName;
              switch (M) {
                case "select":
          ...
          for (var t = 0; t < 8; ) {
            ...
            if (q) {
              ...
              kt && Ne(we, J)
                ...
                : we._appendChild(Ve);
              for (
                var gr = an(q.ownerDocument, Te.indexOf(T));
                q.hasChildNodes();
        ...
        function ct(e) {
          switch (e) {
            ...
            case -1:
              ...
              break;
            case 61:
              tn(), (Ye += String.fromCharCode(e)), (A = ln);
              break;
            default:
              if (xa()) break;
              tn(), oe(e, ln);
...
`
        ...
        function pi(e) {
          switch (e) {
            case 45:
              xe.push(45), xe.push(45), xe.push(33), (A = fn);
              break;
            case 62:
              (A = ye), Pe(x, Ue(xe));
              break;
        ...
        function Fn(e) {
          switch (e) {
            ...
            case 89:
            case 90:
              Kt(), vt.push(e + 32), (A = hn);
              break;
            case 0:
              Kt(), vt.push(65533), (A = hn);
              break;
            case 62:
              Kt(), ke(), (A = ye), Ce();
              break;
            ...
            case 2:
              switch (t) {
                ...
                case "script":
                  ...
                  return;
                case "template":
                  pe(t, T), Te.insertMarker(), (He = !1), (j = gn), dt.push(j);
                  return;
                case "head":
                  return;
              }
            ...
            case 2:
              switch (t) {
                ...
                case "dt":
                  ...
                  return;
                case "plaintext":
                  C.inButtonScope("p") && fe(y, "p"), pe(t, T), (A = sn);
                  return;
                case "button":
                  C.inScope("button")
                ...
                case "rt":
                  ...
                  return;
                case "math":
                  Ze(), sr(T), ut(T), nn(t, T, a.MATHML), M && C.pop();
                  return;
                case "svg":
                  Ze(), ir(T), ut(T), nn(t, T, a.SVG), M && C.pop();
                  return;
                case "caption":
                case "col":
                case "colgroup":
        ...
        function $e(e, t, T, M) {
          ...
          switch (e) {
            ...
            case 2:
              switch (t) {
                case "caption":
                  C.clearToContext(L), Te.insertMarker(), pe(t, T), (j = mn);
                  return;
                case "colgroup":
            ...
            case 2:
              switch (t) {
                ...
                case "var":
                  if (Ft) break;
                  do C.pop(), (Q = C.top);
                  while (Q.namespaceURI !== a.HTML && !lt(Q) && !ar(Q));
                  Pe(e, t, T, M);
                  return;
              }
              (Q = C.elements.length === 1 && Ft ? V : C.top),
                Q.namespaceURI === a.MATHML
                  ? sr(T)
                  : Q.namespaceURI === a.SVG && ((t = Wt(t)), ir(T)),
                ut(T),
                nn(t, T, Q.namespaceURI),
                M && (t === "script" && (Q.namespaceURI, a.SVG), C.pop());
              return;
            case 3:
              if (
                ((Q = C.top),
                ...
                for (var he = C.elements.length - 1, we = C.elements[he]; ; ) {
                  ...
                  if (((we = C.elements[--he]), we.namespaceURI === a.HTML)) {
                    j(e, t, T, M);
                    break;
                  }
                }
  ...
  cs = ue({
    "external/npm/node_modules/domino/lib/index.js"(v) {
      ...
      (v.createDOMImplementation = function () {
        ...
        (v.createWindow = function (a, c) {
          var l = v.createDocument(a);
          return c !== void 0 && (l._address = c), new n.Window(l);
        }),
        (v.impl = n);
    },
  }),
